    ...
    <div class="content">
        ...
        <div class="left-dash-bar">
            ...
            <div class="left-dash-content">
                ...
                <div class="item" onclick="javascript: location='duyurular.php'">
                    <div class="icon">
        ...
        <div class="new-table">
            <table class="new-content-table" id="new-content-table">
                ...
                $IDLenght = "SELECT ID FROM haberler";

                $resultID = $con->query($IDLenght);

                $sql = "SELECT `ID`, `title`, `author`, `date` FROM haberler";    
                ...
                if($result->num_rows > 0) {
                    while($row = $result->fetch_assoc()) {
                        ...
                        <tr>
                            ...
                            <td>
                             <div class='edit'>
                                 <div class='edit-new pan-new' onclick='javascript:location=`haberDuzenle.php?ID=". $row["ID"] ."`'>
                                    <i class='far fa-edit'></i>
                                 </div> 
                                 <div class='remove-new pan-new del-btn' href='functions/haberSil.php?ID=". $row["ID"] ."'>
        ...
        <div class="user-set-cont" id="set-cont">
                 <div class="form-chng" id="add-user-box">
                    <form action="functions/kullaniciEkle.php" method="POST">
                        <div class="inputs">
                            <h3 class="c-title">Kullanıcı Adı</h3>
                            <input id="add-username" type="text" class="new-title" placeholder="Kullanıcı Adı..." id="username" name="username">
                        </div>
                        <div class="inputs">
                            <h3 class="c-title">Kullanıcı Şifresi</h3>
                            <input id="add-password" type="password" class="new-title" placeholder="Şifre..." id="password" name="password"> 
                        </div>
                        <div class="inputs">
