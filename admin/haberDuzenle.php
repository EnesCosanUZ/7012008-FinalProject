        ...
        <div class="left-dash-bar">
            ...
            <div class="left-dash-content">
                <div class="item active">
                    <div class="icon active" onclick="javascript: location='duyurular.php'">
...
<?php
    ...
    $sql = "SELECT `ID`, `title`, `text` FROM haberler WHERE ID='" . $_GET["ID"] . "'";
...
?>
                    ...
                    <form action="./functions/haberDuzenle.php?ID=<?php echo $row["ID"]?>" method="POST">
                        <div class="inputs">
